...
if __name__ == '__main__':
    ...
    train_X = iris_data['train_X']
    train_Y = iris_data['train_Y']
    test_X = iris_data['test_X']
    test_Y = iris_data['test_Y']
    ...
    MyNet = Net(n_feature=4, n_hidden=5, n_output=2) #You can change the parameters here!
