...
def k_fold(Net, k, X_train, y_train, num_epochs=50, learning_rate=0.0001, batch_size=20):
...
if __name__ == '__main__':
    ...
    wine_data = np.load('wine.npz')
    # print(breast_cancer_data.files)
    # ['train_X', 'train_Y', 'test_X', 'test_Y']

    train_X = wine_data['train_X']
    train_Y = wine_data['train_Y']
    test_X = wine_data['test_X']
    test_Y = wine_data['test_Y']
    ...
    MyNet = Net(n_feature=13, n_hidden=10, n_output=2) #You can change the parameters here!
