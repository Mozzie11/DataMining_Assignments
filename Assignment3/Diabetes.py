...
if __name__ == '__main__':
    ...
    diabetes_data = np.load('diabetes.npz')
    # print(breast_cancer_data.files)
    # ['train_X', 'train_Y', 'test_X', 'test_Y']

    train_X = diabetes_data['train_X']
    train_Y = diabetes_data['train_Y']
    test_X = diabetes_data['test_X']
    test_Y = diabetes_data['test_Y']
    ...
    MyNet = Net(n_feature=8, n_hidden=10, n_output=2) #You can change the parameters here!
