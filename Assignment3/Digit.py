...
if __name__ == '__main__':
    ...
    digit_data = np.load('digit.npz')
    # print(breast_cancer_data.files)
    # ['train_X', 'train_Y', 'test_X', 'test_Y']

    train_X = digit_data['train_X']
    train_Y = digit_data['train_Y']
    test_X = digit_data['test_X']
    test_Y = digit_data['test_Y']
    ...
    MyNet = Net(n_feature=64, n_hidden=8, n_output=2) #You can change the parameters here!
